          ...
          <CardHeader>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-4 w-full max-w-full">
                ...
                >
                  <a href={`${import.meta.env.BASE_URL}old-leaderboards`} className="flex items-center justify-center w-full">
                            ...
                            {paginatedData.map((entry) => (
                              <TableRow key={entry.player} className="hover:bg-muted/50 transition-colors">
                                ...
                                <TableCell>
                                  ...
                                  >
                                    <a href={`${import.meta.env.BASE_URL}player/${encodeURIComponent(entry.player)}`}>
                                      View Profile
                                    </a>
                                  </Button>
                                </TableCell>
